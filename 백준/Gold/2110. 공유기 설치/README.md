...
### 풀이
<p>https://kau-algorithm.tistory.com/851</p>
<p>이분탐색 문제를 풀 때 주어진 데이터들에 대해 무작정 탐색을 적용하지 않고 탐색의 대상을 정확히 인지하는 것이 중요하다.</p>
<p>이번 문제의 경우 '공유기 간 거리의 최솟값'이 탐색의 대상이었고 주어진 집의 위치에 대해서는 하나하나 반복문을 돌았다.</p>
